...
@author: frohro
This example shows how to use the PySAM API to create a CustomGeneration simulation, and then use that same data to create a Grid and Singleowner simulation. The three simulations are then executed, and the outputs of the CustomGeneration simulation are printed as a dictionary.
"""
import json
